...
typedef struct
{
    ...
    clock_names_t source[PWM_INSTANCE_MAX];       /*!< PWM modue clock source.            */
} ckgen_tclk_config_t;
...
typedef struct
{
    ...
    ckgen_system_clock_src_t    alternateClock;  /*!< Alternate clock used during initialization      */
 ...
 * @return  none
 */
void CKGEN_DRV_SoftReset(ckgen_softreset_t module, bool active);
