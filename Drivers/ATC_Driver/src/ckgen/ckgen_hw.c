...
{
    __IO uint32_t bitFileVal = 0U;
    __IO uint32_t mask = CKGEN_PERI_CLK_MUX1_CAN0_MUX_Msk, pos = CKGEN_PERI_CLK_MUX1_CAN0_MUX_Pos;
...
{
    __IO uint8_t extSrcEn = 0U;
    __IO uint32_t src = 0U, bitFiledVal = 0U;
    __IO uint32_t regVal = CKGEN->PERI_CLK_MUX3; /* Read register value */
    __IO uint32_t bitFiledMask = CKGEN_PERI_CLK_MUX3_PWM0_INT_Msk \
                              | CKGEN_PERI_CLK_MUX3_PWM0_EXT_IN_Msk \
                              | CKGEN_PERI_CLK_MUX3_PWM0_EXT_Msk;
    __IO uint32_t bitFiledWidth = 5U;
...
{
    __IO uint32_t periphName = (uint32_t)((uint32_t)peripheralName - (uint32_t)CKGEN_PERI_CLK_BASE);
    __IO uint32_t bitFileVal = 0U;
